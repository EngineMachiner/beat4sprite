...
return Def.ActorFrame{
	...
	LoadActor( file )..{
		RepeatCommand=cmd(hibernate,0.45;x,400;y,_screen.h; zoom,0; bounce; effectmagnitude,0,-200,0; effectoffset,0.2; linear,SongBeat+math.random(0.1000,1.000).2;zoom,1.5; effectclock,'beat';effectoffset,0.5; blend,Blend.Add; queuecommand,"Repeat");
	},
	...
	LoadActor( file )..{
		RepeatCommand=cmd(hibernate,1.2;x,600;y,_screen.h; zoom,0; bounce; effectmagnitude,0,-120,0; effectoffset,0.1; linear,SongBeat+math.random(0.1000,1.000).4;zoom,1;effectoffset,0.85; effectclock,'beat'; blend,Blend.Add; queuecommand,"Repeat");
	}
}