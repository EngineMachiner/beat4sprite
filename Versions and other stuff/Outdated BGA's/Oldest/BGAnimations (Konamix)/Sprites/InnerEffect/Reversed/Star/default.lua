...
local file = ... or "Star.png"
local file2 = "Flower.png"

local AnimateThisActor = function( self, start_x, start_y, tween_duration )
	self:xy( _screen.cx, _screen.cy )
		:zoom(0):blend(Blend.Add):rotationz(0)
		:linear( tween_duration+math.random(0.2500,0.7500) ):zoom(1):xy( start_x, start_y )
