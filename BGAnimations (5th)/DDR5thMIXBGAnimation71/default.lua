local t = Def.ActorFrame{
	...
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,394;y,60)
	};
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,711;y,60)
	};
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,869;y,60)
	};
	LoadActor("1 TileStill 2x1.png")..{
	...
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,394;y,180)
	};
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,711;y,180)
	};
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,869;y,180)
	};
	LoadActor("1 TileStill 2x1.png")..{
	...
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,394;y,300)
	};
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,711;y,300)
	};
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,869;y,300)
	};
	LoadActor("1 TileStill 2x1.png")..{
	...
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,394;y,420)
	};
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,711;y,420)
	};
	LoadActor("1 TileStill 2x1.png")..{
		OnCommand=cmd(x,869;y,420)
	};
};
