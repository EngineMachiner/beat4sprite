...
return Def.ActorFrame{
	...
	Def.Quad{
		OnCommand=function(self)
			self:xy(SCREEN_CENTER_X,SCREEN_CENTER_Y):zoomto(SCREEN_WIDTH,SCREEN_HEIGHT):diffusealpha(0)
		end,
	},
		LoadActor("../Backgrounds/Rainbow/Solar.png")..{
			OnCommand=function(self)
			self:Center():blend("BlendMode_Add"):rainbow():diffusealpha(0.25):zoom(ScaleVar)
			end
		},
}
