...
for i=1,3 do
	t[i+3*5] = LoadActor(particle)..{
			...
			ContinueCommand=function(self)
				self:sleep(11/6):rotationz(135):diffusealpha(0):z(125*ScaleVar):linear(0.25):diffusealpha(1):linear(4):z(-1000*ScaleVar):playcommand("Spin"):linear(0.25):diffusealpha(0):set_tween_uses_effect_delta(true):effectclock('beat'):queuecommand("Continue")
			end,
