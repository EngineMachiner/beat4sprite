...
return Def.ActorFrame{
	LoseFocusCommand=function(self)
		...
		Def.Sprite{
		Texture = "../Backgrounds/5th/DanceBackgrounds/4 (stretch).png", 
		...
		Def.Sprite{
		Texture = "../Backgrounds/5th/DanceBackgrounds/3 (stretch).png", 
		...
		Def.Sprite{
		Texture = "../Backgrounds/5th/DanceBackgrounds/2 (stretch).png", 
		...
		Def.Sprite{
		Texture = "../Backgrounds/5th/DanceBackgrounds/1 (stretch).png", 
