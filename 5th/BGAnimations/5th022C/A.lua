...
return Def.ActorFrame{
	LoseFocusCommand=function(self)
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/DanceBackgrounds/8 (stretch).png", 
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/DanceBackgrounds/7 (stretch).png", 
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/DanceBackgrounds/6 (stretch).png", 
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/DanceBackgrounds/5 (stretch).png", 
