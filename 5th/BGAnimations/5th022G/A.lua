...
return Def.ActorFrame{
	LoseFocusCommand=function(self)
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/DanceBackgrounds/12 (stretch).png", 
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/DanceBackgrounds/11 (stretch).png", 
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/DanceBackgrounds/10 (stretch).png", 
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/DanceBackgrounds/9 (stretch).png", 
