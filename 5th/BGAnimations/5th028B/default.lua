...
return Def.ActorFrame{
	...
	LoadActor("../ParticleEffects/SpiralSpriteZoomIn/001", "/BGAnimations/Sprites/Jewel.png", "/BGAnimations/Sprites/Ring.png", 0)..{ OnCommand=function(self) self:addx(WDX3) end },
}