...
return Def.ActorFrame{
	...
	LoadActor("/BGAnimations/Backgrounds/5th/42 (stretch).png")..{
	...
	LoadActor("/BGAnimations/Backgrounds/5th/42 (stretch).png")..{
		...
		LoadActor("../Scripts/Line/001", "/BGAnimations/Sprites/5th/Burger.png", "/BGAnimations/Sprites/5th/Cake.png", 0, ScaleVar)..{},
}