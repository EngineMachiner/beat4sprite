...
return Def.ActorFrame{
	LoseFocusCommand=function(self)
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/36 (stretch)", 
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/35 (stretch)", 
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/34 (stretch)", 
		...
		Def.Sprite{
		Texture = "/BGAnimations/Backgrounds/5th/33 (stretch)", 
